export const schema = {
  "type": "object",
  "title": "Solr Index",
  "description": "A connector that pulls selected documents from an external Solr instance or cluster.",
  "required": [
    "id",
    "connector",
    "type",
  ...
  "properties": {
    ...
    "type_description": {
      ...
      "default": "A connector that pulls selected documents from an external Solr instance or cluster.",
      "hints": [
        "hidden",
        "readonly"
      ]
    ...
    "properties": {
      ...
      "properties": {
        ...
        "solr_base_url": {
          "type": "string",
          "title": "Standalone Solr server base URL",
          "description": "If using a single Solr instance, enter the base URL, e.g.,  http://solrhost.example.com:8983/solr/."
        },
        "zk_host_string": {
          "type": "string",
          "title": "SolrCloud ZooKeeper host string",
          "description": "If using a SolrCloud instance, enter the ZooKeeper connect string, e.g., zkServerA:2181,zkServerB:2181,zkServerC:2181/solr."
        },
        "source_collection": {
          "type": "string",
          "title": "Source collection",
          "description": "Collection or Core name in the source Solr instance/cluster. If not defined, the default core will be used."
        },
        "solr_query": {
          "type": "string",
          "title": "Query to execute",
          "description": "Query to select documents from the source Solr instance/cluster. If not defined, the default query *:* will be used.",
          "default": "*:*",
          "minLength": 1
        },
        "solr_filter_queries": {
          "type": "string",
          "title": "Filter queries to execute",
          "description": "Filter queries to select documents from the source Solr instance/cluster. Multiple filter queries should be separated with commas."
        },
        "solr_field_list": {
          "type": "string",
          "title": "Stored fields to retrieve",
          "description": "Fields to fetch from the source Solr instance/cluster, which must be stored fields. Multiple field names should be separated with commas.",
          "default": "*",
          "minLength": 1
        },
        "solr_page_size": {
          "type": "integer",
          "title": "Page size",
          "description": "Number of rows per request to Solr.",
          "default": 100
        },
        "solr_sort_spec": {
          "type": "string",
          "title": "Sort specification",
          "description": "Sort order for the request. The uniqueKey field must be included as one of the sorted fields.",
          "default": "id asc",
          "minLength": 1
        },
        "solr_request_handler": {
          ...
          "description": "The request handler to use for the request to the Solr instance/cluster.",
          "default": "/select",
          "minLength": 1
        },
        "solr_query_parser": {
          "type": "string",
          "title": "Query parser",
          "description": "The query parser to use for the request."
        },
        "commit_on_finish": {
          "type": "boolean",
