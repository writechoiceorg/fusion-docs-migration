export const schema = {
  "category": "Other",
  "categoryPriority": 1,
  "description": "A crawler for SharePoint- using SharePoint Rest.",
  "properties": {
    "category": {
      "default": "Repository",
      "hints": [
    ...
    "properties": {
      ...
      "properties": {
        ...
        "f.username": {
          "description": "Name of a Sharepoint user who has the required permissions to access Sharepoint via the REST API.",
    ...
    "type_description": {
      "default": "A crawler for SharePoint- using SharePoint Rest.",
      "hints": [
        "hidden",
        "readonly"
      ],
