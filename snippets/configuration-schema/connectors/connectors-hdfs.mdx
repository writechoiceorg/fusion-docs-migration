    ...
    "properties": {
      ...
      "properties": {
        ...
        "url": {
          "type": "string",
          "title": "Start link",
          "description": "The start link is the URI for the HDFS connector. The `namenode` is 8020 by default, e.g., hdfs://hmbrnasnfs2.highmark.com:8020/datalake/hm/phi/refined/UnstructuredData/NEPA",
          "minLength": 1,
          "pattern": ".*:.*"
        },
        "max_docs": {
