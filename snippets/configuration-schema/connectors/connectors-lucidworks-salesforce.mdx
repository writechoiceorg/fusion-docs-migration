    ...
    "properties": {
      ...
      "properties": {
        "timeoutsProperties": {
          ...
          "interfaces": [
            "com.lucidworks.connector.plugins.salesforce.config.ConnectionTimeoutsConfig$Properties",
        ...
        "authentication": {
          "type": "object",
          "title": "Salesforce Authentication Properties",
          "required": [
            "clientId",
            "instanceUrl",
            "refreshToken"
          ...
          "properties": {
            "instanceUrl": {
              "type": "string",
              "title": "Instance URL",
              "description": "URL of your Salesforce instance",
              "minLength": 1
            },
            "refreshToken": {
              "type": "string",
            ...
            "clientId": {
              "type": "string",
              "title": "Client Id",
              "description": "Consumer key of connected App",
              "hints": [
                "secret"
              ],
              "minLength": 1
            ...
            "clientSecret": {
              "type": "string",
              "title": "Client Secret",
              "description": "Consumer secret of connected App. It is used to generate refresh token and will not be stored in the configuration.",
              "hints": [
                "uionly",
                "secret"
              ]
          ...
          "interfaces": [
            "com.lucidworks.connector.plugins.salesforce.config.AuthenticationConfig$Properties"
          ]
        },
        "indexing": {
          "type": "object",
          "title": "Salesforce Indexing Properties",
          "required": [
            "objects"
          ],
          "properties": {
            ...
            "batchSize": {
              "type": "number",
              "title": "Batch size",
              "description": "Salesforce Bulk API batch size",
              "default": 500,
              "hints": [
                "advanced"
              ],
          ...
          "interfaces": [
            "com.lucidworks.connector.plugins.salesforce.config.IndexingConfig$Properties"
          ]
        },
        "security": {
          "type": "object",
      ...
      "interfaces": [
        "com.lucidworks.connector.plugins.salesforce.config.SalesforceConfig$Properties",
        "com.lucidworks.connector.plugins.salesforce.config.AuthenticationConfig",
        "com.lucidworks.connector.plugins.salesforce.config.ConnectionTimeoutsConfig",
        "com.lucidworks.fusion.connector.plugin.api.config.ConnectorPluginProperties",
        "com.lucidworks.connector.components.httpclient.config.ConnectionsConfig",
        "com.lucidworks.connector.plugins.salesforce.config.IndexingConfig",
