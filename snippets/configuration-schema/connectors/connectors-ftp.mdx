export const schema = {
  "type": "object",
  "title": "FTP",
  "description": "A crawler for FTP sites using either simple FTP or SFTP.",
  "required": [
    "id",
    "connector",
    "type",
  ...
  "properties": {
    ...
    "type_description": {
      ...
      "default": "A crawler for FTP sites using either simple FTP or SFTP.",
      "hints": [
        "hidden",
        "readonly"
      ]
    ...
    "properties": {
      ...
      "properties": {
        ...
        "url": {
          "type": "string",
          "title": "Start link",
          "description": "The link to the FTP site that is being crawled. It can point to a subdirectory, or the root of the site to crawl the entire site, e.g., ftp://ftp.example.com:21/some_folder/",
          "minLength": 1,
          "pattern": ".*:.*"
        },
        "max_docs": {
        ...
        "username": {
          "type": "string",
          "title": "Username",
          "description": "Username with permissions to access the repository, if necessary."
        },
        "password": {
          "type": "string",
          "title": "Password",
