export const schema = {
  ...
  "properties": {
    "category": {
      "default": "A connector that generates different types of documents(Type A, B, C and D), permissions for those documents and user/groups.",
      "hints": [
        "hidden",
        "readonly"
      ],
    ...
    "properties": {
      ...
      "interfaces": [
        "com.lucidworks.connectors.plugins.security.config.SecurityFilteringConfig$Properties",
