    ...
    "properties": {
      ...
      "properties": {
        "fetchThreads": {
          "type": "integer",
          "title": "Fetch threads",
          "description": "The number of threads to use during fetching. The value is 1 when 'enterprise:false', if 'enterprise:true' the threads can be incremented",
          "default": 1
        },
        "startLinks": {
          "type": "array",
          "title": "Start Links",
          "description": "The link to the GitHub repository to be crawled, e.g., https://github.com/lucidworks/fusion-cloud-native",
          "items": {
            "type": "string",
            "minLength": 1
          }
        ...
        "f.github_accept_self_signed_ssl_certificate": {
          "type": "boolean",
          "title": "Accept self signed SSL certificate",
          "default": true
        },
        "f.branches": {
          "type": "boolean",
