export const schema = {
    ...
    "properties": {
      ...
      "properties": {
        ...
        "azureProperties": {
          ...
          "properties": {
            ...
            "onPremisesDomainMappings": {
              ...
              "items": {
                ...
                "interfaces": [
                  "com.lucidworks.connector.plugins.ldapacls.config.OnPremisesDomainMapping"
                ]
              }
            },
            "userBatchSize": {
          ...
          "interfaces": [
            "com.lucidworks.connector.plugins.ldapacls.config.AzureAuthenticationConfig"
          ]
        },
        "aclZkHosts": {
          "type": "string",
      ...
      "interfaces": [
        "com.lucidworks.connector.plugins.ldapacls.config.LdapAclsConfig$Properties",
  ...
  "category": "LDAP",
  "interfaces": [
    "com.lucidworks.connector.plugins.ldapacls.config.LdapAclsConfig",
