export const schema = {
  ...
  "description": "Finding outliers from a set of documents and attach labels for each outlier group.",
  "required": [
    "id",
    "trainingCollection",
    "fieldToVectorize",
  ...
  "properties": {
    ...
    "outputOutliersOnly": {
      "type": "boolean",
      "title": "Whether only save outliers in the output collection",
      "description": "If ture, only outliers are saved in the output collection, o.w., the whole dataset.",
      "default": false
    },
    "uidField": {
      "type": "string",
