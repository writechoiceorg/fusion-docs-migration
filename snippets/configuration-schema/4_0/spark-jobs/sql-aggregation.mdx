export const schema = {
  "type": "object",
  "title": "Aggregation",
  "description": "Define an aggregation job to be executed by Fusion Spark.",
  "required": [
    "id",
    "inputCollection",
    "type"
    ...
    "definition": {
      ...
      "properties": {
        ...
        "sourceCatchup": {
          "type": "boolean",
          "title": "Catchup",
          "description": "If true, only aggregate the signals since the last time the job was successfully run. If there is a record of such previous run then this overrides the starting time of time range set in 'timeRange' property.",
          "default": true,
          "hints": [
            "advanced"
          ]
