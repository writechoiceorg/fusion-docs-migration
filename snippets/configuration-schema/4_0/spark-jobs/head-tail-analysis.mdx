export const schema = {
  ...
  "description": "Perform head tail analysis of queries from raw or aggregated signals collection.",
  "required": [
    "id",
    "trainingCollection",
    "fieldToVectorize",
  ...
  "properties": {
    ...
    "outputCollection": {
      ...
      "description": "Solr collection to store head tail analytics results. Defaults to aggr collection",
      "hints": [
        "advanced"
      ]
    },
    ...
    "lenScale": {
      ...
      "description": "A scaling factor which control the filtering of head and tail string match based on edit distance. The filtering is that the edit_dist <= string_length/length_scale. A large number leads to shorter spelling list.A small number leads to longer spelling list but may add lower quality corrections.",
      "default": 6,
      "hints": [
        "advanced"
      ]
    ...
    "overlapThreshold": {
      ...
      "description": "The threshold for the number of overlapping tokens between the head and tail. When a head string and tail string share more tokens than this threshold, they are considered good match.",
      "default": 4,
      "hints": [
        "advanced"
      ]
