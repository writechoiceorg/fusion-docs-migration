export const schema = {
  ...
  "description": "Clustering a set of documents and attach cluster labels",
  "required": [
    "id",
    "trainingCollection",
    "fieldToVectorize",
  ...
  "properties": {
    ...
    "kDiscount": {
      ...
      "description": "When using Calinsky index to choose K, apply k^kDiscount to discount large k number difference",
      "default": 0.7,
      "hints": [
        "advanced"
      ]
