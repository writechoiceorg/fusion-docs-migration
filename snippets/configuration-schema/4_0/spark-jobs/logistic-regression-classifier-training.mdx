export const schema = {
  "type": "object",
  "title": "Logistic Regression Classifier Training",
  "description": "Trains a regularized logistic regression model for text classification",
  "required": [
    "id",
    "trainingCollection",
    "fieldToVectorize",
  ...
  "properties": {
    ...
    "maxIters": {
      ...
      "description": "Will stop after this many, even if convergence criterion has not been reached earlier",
      "default": 10
    },
    "type": {
      "type": "string",
