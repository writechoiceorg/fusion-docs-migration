export const schema = {
  ...
  "description": "Train a collaborative filtering matrix decomposition recommender using SparkML's Alternating Least Squares (ALS) to batch compute user recommendations and item similarities",
  "required": [
    "id",
    "trainingCollection",
    "type"
