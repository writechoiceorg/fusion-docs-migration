export const schema = {
  ...
  "description": "Compute basic metrics about a collection and write back to an output collection",
  "required": [
    "id",
    "trainingCollection",
    "fieldToVectorize",
  ...
  "properties": {
    ...
    "numDeviations": {
      "type": "integer",
      "title": "Num Deviations",
      "description": "Number of standard deviations away from the mean we deem acceptable for this collection.If you want all the documents set this to be high.",
      "minimum": 0,
