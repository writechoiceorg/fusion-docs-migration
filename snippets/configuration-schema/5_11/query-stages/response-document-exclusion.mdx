export const schema = {
  ...
  "description": "This stage drops a document from the response if all of the specified rules match; otherwise, passes the document through unchanged.  It does not replace them.",
  "required": [
    "matchRules"
  ],
  "properties": {
