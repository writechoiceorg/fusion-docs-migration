export const schema = {
  "type": "object",
  "title": "Ray / Seldon Vectorize Field",
  "description": "Invokes Ray or Seldon machine learning model to encode a string field to a vector representation. Will be skipped if the field to encode doesn't exist or is null on the pipeline document.",
  "required": [
    "modelId",
    "modelInputFieldName",
