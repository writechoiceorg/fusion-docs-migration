export const schema = {
  "type": "object",
  "title": "Forked Apache Tika (Deprecated)",
  "description": "A simplified Apache Tika parser more geared towards an Enterprise Search crawl where all documents are parsed in a forked Java Virtual Machine. This stage is deprecated. Use async-parsing instead.",
  "required": [
    "type"
  ],
  "properties": {
    "id": {
      "type": "string",
      "title": "Parser ID",
      "default": "c4c5a35a-437d-4d79-a175-64da6502b30c"
    },
    "label": {
      "type": "string",
      "title": "Label",
