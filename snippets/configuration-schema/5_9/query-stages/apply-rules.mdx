export const schema = {
  ...
  "properties": {
    ...
    "hierarchicalFilter": {
      ...
      "description": "Document fields that use delimiters to express a hierarchical structure.",
      "items": {
        "type": "object",
        "required": [
          "field",
    ...
    "emConfig": {
      "type": "object",
      "title": "Experience Manager Configuration",
      "description": "This values applies only when application is connected to Experience Manager.",
      "properties": {
        "abTestHashHeader": {
          "type": "string",
          "title": "AB Test Header for Variant Selection",
          "description": "Http header with value to use for A/B test determined variant selection",
          "default": "User-Agent"
        }
      }
    }
