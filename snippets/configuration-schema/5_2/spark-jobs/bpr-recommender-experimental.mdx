export const schema = {
  ...
  "properties": {
    ...
    "outputItemSimCollection": {
      ...
      "minLength": 1,
      "title": "Item-Items Output Collection",
      "type": "string"
    },
    ...
    "trainingCollection": {
      "description": "User/Item preference collection (aggregated signals). In most cases signals aggregation collection should be used.",
      "minLength": 1,
