export const schema = {
  "type": "object",
  "title": "Tika Server Parser",
  "description": "Parser connecting to a standalone Tika server for text extraction (BETA). WARNING Tika server does not support TLS, therefore this parser will not work in TLS deployments.",
  "required": [
    "type"
  ],
  "properties": {
