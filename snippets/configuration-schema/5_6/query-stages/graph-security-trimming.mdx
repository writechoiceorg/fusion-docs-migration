export const schema = {
  ...
  "properties": {
    ...
    "excludeDatasources": {
      ...
      "description": "Do not perform security trimming on documents from the specified data source ID(s). In other words, make these data sources public."
    },
    "includeDatasources": {
      "type": "string",
      "title": "Inclusive Data Source ID(s)",
      "description": "Only perform security trimming on documents from the specified data source ID(s). In other words, you will be making any data from another data source ID will be public."
    },
    "joinMethod": {
      "type": "string",
      "title": "Join method",
