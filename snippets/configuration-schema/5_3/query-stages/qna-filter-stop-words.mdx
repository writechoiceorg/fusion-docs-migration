export const schema = {
  "type": "object",
  "title": "QnA Filter Stop Words",
  "description": "Filter stop words from query",
  "required": [
    "inputParam",
    "stopWords"
  ],
  "properties": {
    ...
    "inputParam": {
      "type": "string",
      "title": "Input parameter to filter",
      "description": "Input parameter to filter",
      "default": "q",
      "minLength": 1
    },
    "stopWords": {
      ...
      "description": "Comma delimited list of words to filter",
