export const schema = {
  ...
  "properties": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "ensuredValues": {
            ...
            "description": "Field values to include statistics for, even if they don't fall within the natural top-\"limit\" values for the facet",
            "items": {
              "type": "string"
            }
          }
    ...
    "threads": {
      ...
      "description": "Specifies how many threads the search engine will use while loading the underlying fields used in faceting. Recommended that this is kept at 0 or blank, which means the data is loaded in the thread already running the query."
    },
    "rangeFacets": {
      "type": "array",
