export const schema = {
  ...
  "properties": {
    ...
    "overlaps": {
      ...
      "description": "Choose the algorithm to determine which tags in an overlapping set should be retained, versus being pruned away.  Ignored on DSL requests.  Options are: ALL, NO_SUB, LONGEST_DOMINANT_RIGHT; defaults to LONGEST_DOMINANT_RIGHT",
      "enum": [
        "ALL",
        "NO_SUB",
