export const schema = {
  ...
  "description": "Parse Office documents (ppt/docx/pdf), HTML files, images (jpeg/tiff), and more. See \"Supported Formats\" at https://tika.apache.org/ for a full list. This stage is deprecated. Use async-parsing instead.",
  "required": [
    "type"
  ],
  "properties": {
    "id": {
      "type": "string",
      "title": "Parser ID",
      "default": "44e43d53-fc18-4d99-9201-84c32be234d9"
    },
    "label": {
      "type": "string",
      "title": "Label",
