export const schema = {
  ...
  "properties": {
    ...
    "join": {
      ...
      "description": "If true, the results will be added on to the request using the prefix key and the row id, else the results will be put in the pipeline context using",
      "default": true,
      "hints": [
        "advanced"
      ]
