...
If you specify API permissions in a user definition, those permissions *override* corresponding permissions defined in the user’s roles. See [Permissions](/fusion-server/4.2/123/permissions) for more information about how permissions supplied by multiple roles and by user definitions combine.
...
See page [Users API](/fusion-server/4.2/340/user-api).
...
* `realm-name`– The Fusion [security realm](/fusion-server/4.2/127/security-realms) name; the default is "native".
