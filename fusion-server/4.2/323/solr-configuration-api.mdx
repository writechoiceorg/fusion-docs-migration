...
To manage Solr synonym lists, use the [Synonyms Editor API](/fusion-server/4.2/335/synonyms-editor-api).

To manage Solr lists of stopwords, see [Stopwords Files](/fusion-server/4.2/181/stopwords-files).
