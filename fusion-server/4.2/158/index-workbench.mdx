...
<Frame>![Index Workbench](/assets/images/4.2/index-workbench.png)</Frame>

## Datasources

<Frame>![New datasource](/assets/images/4.2/index-workbench-new.png)</Frame>
...
[Parsers](/fusion-server/4.2/370/parsers) are a configurable component of the indexing workflow, for flexibility and specificity when parsing inbound data.

<Frame>![Parsers](/assets/images/4.2/index-workbench-parsers.png)</Frame>
...
An [Index Pipeline](/fusion-server/4.2/162/index-pipelines) transforms incoming data into a document suitable for indexing by Solr via a series of modularized operations called stages. Fusion provides a variety of specialized index stages to index data effectively. Stages can be selected, configured, and enabled or disabled in the Index Pipeline section of the Index Workbench.

<Frame>![Index pipeline stages](/assets/images/4.2/index-workbench-stages.png)</Frame>

Once you finish configuring a datasource using the Index Workbench, you can move on to setting up queries using the [Query Workbench](/fusion-server/4.2/167/query-workbench), which provides a similar workflow for configuring and previewing search results.

### Adding a pipeline stage

Click **Add a Stage** to add index pipeline stages that can perform data filtering, transformations, and more.

<Frame>![Add a stage](/assets/images/4.2/index-workbench-stages-add.png)</Frame>

The [Solr Indexer stage](/fusion-server/4.2/227/solr-indexer-stage)
is the only pipeline stage that is required to complete the indexing process, and therefore exists in every index pipeline. It is always the last stage in a series.
...
<Frame>![Re-order stages](/assets/images/4.2/index-workbench-stages-reorder.png)</Frame>

Drag any stage in the pipeline to move it up or down in the sequence of stages. The preview panel automatically updates the results to reflect the output of the new sequence.
...
<Frame>![Enable/disable stages](/assets/images/4.2/index-workbench-stages-disable.png)</Frame>
