...
For more complex logic, use a [JavaScript Index Stage](/fusion-server/4.2/243/java-script-index-stage).
...
import {schema} from "/snippets/configuration-schema/4_2/index-stages/set-property.mdx";
