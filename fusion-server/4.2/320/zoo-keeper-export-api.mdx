---
title: "ZooKeeper Export API"
permalink: "320"
---


The ZooKeeper Export API provides methods to upload or download information from
...
* For details on using this script to migrate Fusion configurations from one deployment to another, see
  [Migrating Fusion Objects by Hand](/how-to/836/migrate-fusion-objects).
