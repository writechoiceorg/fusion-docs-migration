...
|  |  |
| --- | --- |
| **Endpoint URI** / `uri` | A fully-qualified service URI. This can be an HTTP call, a Solr request, or a Fusion service call<br/>  * any HTTP or HTTPS request: `<http-protocol>://<path>`<br/>  * a Solr request: `solr://<collection>/…​`<br/>  * a Fusion service request: `extservice://<serviceName>/<path>` |
...
import {schema} from "/snippets/configuration-schema/4_2/index-stages/rest-query.mdx";
