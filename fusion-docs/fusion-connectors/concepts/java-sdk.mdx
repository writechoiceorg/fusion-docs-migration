...
[Connector client utility](https://doc.lucidworks.com/how-to/java-connector-dev.html#plugin-client).

### Examples

The example connectors are a great place to start understanding how to build a Java SDK Connector.
Have a look at the [example connectors documentation](https://github.com/lucidworks/connectors-sdk-resources/blob/master/java-sdk/connectors/README.md).

### Security

Read more on how to set up a secure environment for Java SDK connectors
[here](https://doc.lucidworks.com/how-to/java-connector-dev.html#java-sdk-security).
...
at an example
[here](https://github.com/lucidworks/connectors-sdk-resources/blob/master/java-sdk/connectors/build.gradle).
...
Have a look at the example [here](https://github.com/lucidworks/connectors-sdk-resources/blob/master/java-sdk/connectors/simple-connector/gradle.properties).
...
[here](https://github.com/lucidworks/connectors-sdk-resources/blob/master/java-sdk/connectors/simple-connector/src/main/java/com/lucidworks/fusion/connector/plugin/RandomContentPlugin.java).
...
[here](https://github.com/lucidworks/connectors-sdk-resources/blob/master/java-sdk/connectors/simple-connector/src/main/java/com/lucidworks/fusion/connector/plugin/RandomContentConfig.java).
...
The simplest way to get started developing a connector is to review the [examples](https://github.com/lucidworks/connectors-sdk-resources/tree/master/java-sdk/connectors/simple-connector).
