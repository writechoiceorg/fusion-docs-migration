...
The Pipl search platform adds support to Appkit for the Pipl search engine for detailed people results from a range of sources.

## Setup

To add Pipl connectors to a Maven project, you must add this dependency to your project’s `pom.xml` file:

```xml
<dependency>
    <groupId>twigkit</groupId>
    <artifactId>twigkit.pipl</artifactId>
...
- `apiKey (java.lang.String)`
    The API Key for programmatic access to Pipl.
