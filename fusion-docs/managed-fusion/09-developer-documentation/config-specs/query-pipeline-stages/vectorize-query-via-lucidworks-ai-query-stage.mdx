...
More detailed information to configure this stage is in [Configure Neural Hybrid Search](/how-to/56o1tt/configure-neural-hybrid-search).
...
import {schema} from "/snippets/configuration-schema/5_9/query-stages/lwai-vectorize-query.mdx";
