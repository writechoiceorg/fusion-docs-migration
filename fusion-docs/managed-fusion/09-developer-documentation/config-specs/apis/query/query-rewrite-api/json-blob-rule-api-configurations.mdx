      ...
      <td>
        ```json
        {
          "matching": {
            ...
            "description": "Defines how the specified search terms will be compared to the user's query: 'keywords' for exact match, 'phrase' for subphrase, 'text' for partial match.",
      ...
      <td>
        ```json
        {
          "blobType": {
            "type": "string",
            "title": "Blob Type",
            "description": "Indicates what kind of data this blob contains. Controls where the blob shows up in the Managed Fusion response at /fusion/jsonBlob/(blobType). Defaults to 'default'.",
            "default": "default"
          }
        }
        ```
