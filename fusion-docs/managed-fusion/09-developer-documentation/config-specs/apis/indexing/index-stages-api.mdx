...
See the section [Index Pipeline Stages](/managed-fusion/5.9/50yh1o/index-pipeline-stages) for a taxonomy of index stage types.
...
```bash
curl -u USERNAME:PASSWORD https://EXAMPLE_COMPANY.b.lucidworks.cloud/api/index-stages/schema/regex-extractor
