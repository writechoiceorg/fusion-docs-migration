...
```sh
curl -u USERNAME:PASSWORD https://EXAMPLE_COMPANY.b.lucidworks.cloud/api/system/metricNames?prefix=mem.heap
```
...
```sh
curl -u USERNAME:PASSWORD https://EXAMPLE_COMPANY.b.lucidworks.cloud/api/system/metrics?pattern=com.lucidworks.apollo.*pipeline.index.*&pretty=true&showSamples=true
```
...
```sh
curl -u USERNAME:PASSWORD https://EXAMPLE_COMPANY.b.lucidworks.cloud/api/system/threads
```
...
```sh
curl -u USERNAME:PASSWORD -X PUT https://EXAMPLE_COMPANY.b.lucidworks.cloud/api/system/buffers
```
...
```sh
curl -u USERNAME:PASSWORD https://EXAMPLE_COMPANY.b.lucidworks.cloud/api/system/ping
```
