...
See [Recommendations and Boosting](/managed-fusion/5.9/k90ww9/recommendations) for a discussion of when to use the API and when to use recommender query stages.
