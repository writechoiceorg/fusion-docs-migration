...
You configure a Grok parsing stage to use predefined [Grok patterns](/managed-fusion/5.9/hendcp/grok-patterns) (about 300 patterns are available) and/or Grok pattern definitions that you write yourself.
...
import {schema} from "/snippets/configuration-schema/5_9/parsers/grok.mdx";
