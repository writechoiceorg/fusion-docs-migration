...
| **Output** | [Items-for-item recommendations](/managed-fusion/5.9/ft2bqg/items-for-item-recommendations) (the `COLLECTION_NAME_content_recs` collection by default) |
