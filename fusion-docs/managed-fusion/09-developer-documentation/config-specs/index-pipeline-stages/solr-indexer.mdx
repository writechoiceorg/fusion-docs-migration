...
A Solr Indexer stage transforms a Managed Fusion PipelineDocument into a Solr document and sends it to Solr for indexing into a collection.
...
import {schema} from "/snippets/configuration-schema/5_9/index-stages/solr-indexer.mdx";
