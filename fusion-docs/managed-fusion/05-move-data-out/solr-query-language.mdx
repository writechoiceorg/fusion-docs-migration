---
title: "Solr query language"
permalink: "b4lyep"
---

This cheat sheet is a quick reference to the Solr query language. Use this syntax when querying Managed Fusion via the [Query API](/managed-fusion/5.9/eqky5t/query-api#queryid).
...
There are two ways to query a Managed Fusion collection using the parameters below:

* Enter query parameters in the [Query Workbench](/managed-fusion/5.9/ukxc4p/query-workbench) or the Quickstart.
* Append query parameters to the [`/query/{id}` endpoint](/managed-fusion/5.9/eqky5t/query-api#queryid).
