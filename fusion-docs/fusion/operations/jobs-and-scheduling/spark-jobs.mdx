...
Apache Spark can power a wide variety of data analysis jobs. In Fusion, Spark jobs are especially useful for generating [recommendations](/fusion/5.9/475/methods-for-recommendations-and-boosting).

## Spark job subtypes

For the Spark [job type](/fusion/5.9/184/jobs-and-scheduling#job-types), the available subtypes are listed below.

* [SQL Aggregation job](/fusion/5.9/8804/sql-aggregation-jobs)

  A Spark SQL aggregation job where user-defined parameters are injected into a built-in SQL template at runtime.
* [Custom Python job](/fusion/5.9/569/custom-python-jobs)

  The Custom Python job provides user the ability to run Python code via Fusion. This job supports Python 3.6+ code.
* [Script](/fusion/5.9/386/script-jobs)
...
<Note>
See [Additional Spark jobs](/fusion/5.9/385/jobs-configuration-reference) for more information.
</Note>
...
Spark jobs can be created and modified using the [Fusion UI](/fusion/5.9/184/jobs-and-scheduling#jobs-manager) or the [Spark Jobs API](/fusion/5.9/312/spark-jobs-api). They can be scheduled using the Fusion UI or the [Spark Jobs API](/fusion/5.9/312/spark-jobs-api).

For the complete list of configuration parameters for all Spark job subtypes, see the [Jobs Configuration Reference](/fusion/5.9/385/jobs-configuration-reference-reference).
...
The **Course** for **Machine Learning in Fusion** focuses on the basics about machine learning jobs in Fusion:

<Frame>
  <a href="https://academy.lucidworks.com/machine-learning-in-fusion" target="_blank">
    <div class="note-image-wrapper">
      <img noZoom src="/assets/images/training-covers/intro-to-machine-learning.jpg" alt="Machine Learning in Fusion" class="note-image" />
...
* [Ground Truth](/fusion/5.9/567/ground-truth-jobs)
...
These jobs produce data that can be used for query rewriting or to inform updates to the [synonyms.txt file](/fusion/5.9/3240/synonyms).

* [Head/Tail Analysis](/fusion/5.9/552/head-tail-analysis-jobs)
...
* [Phrase Extraction](/fusion/5.9/568/phrase-extraction-jobs)

  Identify multi-word phrases in signals.
* [Synonym Detection Jobs](/fusion/5.9/8803/synonym-detection-jobs)
...
* [Token and Phrase Spell Correction](/fusion/5.9/566/token-and-phrase-spell-correction-job)

  Detect misspellings in queries or documents using the numbers of occurrences of words and phrases.

#### Signals aggregation

* [SQL Aggregation](/fusion/5.9/8804/sql-aggregation-jobs)

  A Spark SQL aggregation job where user-defined parameters are injected into a built-in SQL template at runtime.

#### Experiment analysis

* [Ranking Metrics](/fusion/5.9/575/ranking-metrics-jobs)

  Use this job to calculate relevance metrics by replaying [ground truth queries](fusion/5.9/567/ground-truth-jobs) against catalog data using variants from an [experiment](/fusion/5.9/460/experiments). Metrics include Normalized Discounted Cumulative Gain (nDCG) and others.
...
These jobs analyze signals and generate matrices used to provide [collaborative recommendations](/fusion/5.9/475/methods-for-recommendations-and-boosting).

* [BPR Recommender](/fusion/5.9/8805/bpr-recommender-jobs)
...
* [Query-to-Query Session-Based Similarity jobs](/fusion/5.9/8802/query-to-query-session-based-similarity-jobs)

  This recommender is based on co-occurrence of queries in the context of clicked documents and sessions. It is useful when your data shows that users tend to search for similar items in a single search session. This method of generating query-to-query recommendations is faster and more reliable than the Query-to-Query Similarity recommender job, and is session-based unlike the similar queries previously generated as part of the [Synonym Detection job](/fusion/5.9/8803/synonym-detection-jobs).

### Content-based recommenders

[Content-based recommenders](/fusion/5.9/475/methods-for-recommendations-and-boosting) create matrices of similar items based on their content.

* [Content-Based Recommender](/fusion/5.9/8807/content-based-recommender-jobs-experimental)

  Use this job when you want to compute item similarities based on their content, such as product descriptions.

### Content analysis

* [Cluster Labeling](/fusion/5.9/577/cluster-labeling-jobs)
...
* [Document Clustering](/fusion/5.9/582/document-clustering-jobs)
...
* [Classification job](/fusion/5.9/8808/classification)
...
* [Outlier Detection](/fusion/5.9/578/outlier-detection-jobs)
...
* Available datasources and key features of the Parallel Bulk Loader, see [Parallel Bulk Loader concepts](/fusion/5.9/452/parallel-bulk-loader-pbl).
* Usage and detailed configuration, see [Parallel Bulk Loader configuration reference](/fusion/5.9/557/parallel-bulk-loader).