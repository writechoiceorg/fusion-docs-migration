...
This cheat sheet is a quick reference to the Solr query language. Use this syntax when querying Fusion via the [Query Profiles API](/fusion/5.9/361/query-profiles-api#queryid).
...
* Enter query parameters in the [Query Workbench](/fusion/5.9/167/query-workbench) or the Quickstart.
* Append query parameters to the [`/query/{id}` endpoint](/fusion/5.9/361/query-profiles-api#queryid).
...
* The [Apache Solr Query Guide](https://solr.apache.org/guide/solr/latest/query-guide/common-query-parameters.html) provides complete information about all aspects of Solr queries.
...
The **Course** for **Advanced Query Tools** focuses on advanced query language techniques, such as using query parameters, function queries, nested queries, and different query parsers:

<Frame>
  <a href="https://academy.lucidworks.com/advanced-query-tools" target="_blank">
    <div class="note-image-wrapper">
      <img noZoom src="/assets/images/training-covers/advanced-query-tools.jpg" alt="Advanced Query Tools" class="note-image" />
