...
To learn how to use business rules in the [Rules Editor](/fusion/5.9/491/rules-editor), see [Use Business Rules in the Rules Editor](/how-to/768/use-business-rules-in-the-rules-editor).
...
For complete details, see [General Configurations](/fusion/5.9/8838/general-configurations).
...
For complete details, see [Conditions](/fusion/5.9/8837/conditions).

### Action

Business rule actions define what actions are taken when a rule fires.

For complete details, see [Actions](/fusion/5.9/8836/actions).
...
For complete details, see [Custom Rule Actions](/fusion/5.9/8834/custom-rule-actions). To learn use custom rule actions with the API, see [Create Custom Rule Actions with the API](/how-to/699/create-custom-rule-actions-with-the-api).
...
For instructions about using the QEC, see [Use the Query Elevation Component](/how-to/8867/use-the-query-elevation-component).

## Additional details

### Query pipeline stages for rules

These stages are part of the [default query pipeline](/fusion/5.9/173/query-pipelines#default-query-pipelines):
