...
Query profile triggers can be tested in the [Query Workbench](/fusion/5.9/permalink/167) or with the [Query Pipelines API](/fusion/5.9/360/query-pipelines-api) by setting `queryProfileID` parameter on the request.

For more information, see [Business Rules Conditions Concepts](/fusion/5.9/8837/conditions).
