...
For more information about how to use phrase detection in the [Rules Editor](/fusion/5.9/491/rules-editor), see:

* [Use Query Rewrites in the Rules Editor](/how-to/838/use-query-rewrites-in-the-rules-editor)
* [Use Phrase Detection](/how-to/flp6zc/use-phrase-detection)
