---
title: "Queries-for-Query Recommendations"
permalink: "479"
---
...
<Frame>![Queries-for-query examples](/assets/images/4.2/recommendations-queries-for-query.png)</Frame>

To enable queries-for-query recommendations, use the [Query-to-Query Session-Based Similarity](/fusion/5.9/8802/query-to-query-session-based-similarity-jobs-experimental) job, which is session-based unlike the [Synonym Detection job](/fusion/5.9/8803/synonym-detection-jobs).
