...
Access Templates from the [Rules Editor](/fusion/5.9/491/rules-editor) by navigating to **Relevance > Rules > Templates**. See [Use Predictive Merchandiser Templates](/how-to/3293/use-predictive-merchandiser-templates) for instructions on using Templates.
...
For configuration information, see [Templates UI Configurations Reference](/fusion/5.9/8857/templates-ui-configuration-options) and the [Templating API Configuration Reference](/fusion/5.9/wm0epz/templating-api).
