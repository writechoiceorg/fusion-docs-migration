...
* See [Java Connector Development](/fusion/5.9/hpbgki/java-connector-development) to learn about developing a Java-based connector.
...
For developing a Java SDK based connector, check out the [Java SDK README](java-sdk/README.asciidoc).
...
See the [Simple Connector](/fusion/5.9/cbcyor/simple-demo-connector) example for instructions on how to build, deploy and run.
...
<Note>
For information about Fusion 4.2.x, see [Fusion 4.2.x Connectors SDK](/fusion-connectors/ufq1dm/connectors-sdk-4x).
</Note>
