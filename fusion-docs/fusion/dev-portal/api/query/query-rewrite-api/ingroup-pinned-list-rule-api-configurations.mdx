---
title: "Ingroup Pinned List Rule API Configurations"
...
<tr>
  <td><strong>field_values</strong></td>
  <td>
...
<tr>
  <td><strong>groupValue_s</strong><br/><strong>Required</strong></td>
  <td>

```json
"groupValue_s": {
  "type": "string",
  "title": "Pin Within A Specific Group Value",
  "description": "A single group value in which the pin rule will apply to the docs."
}
```
...
<tr>
  <td><strong>pinned_values</strong><br/><strong>Required</strong></td>
  <td>
...
"pinned_values": {
  ...
  "description": "A list of one or more documents to boost and pin to a specific position in the group (1-based index)",
  "minItems": 1,
  "items": {
    "type": "object",
    "required": [
