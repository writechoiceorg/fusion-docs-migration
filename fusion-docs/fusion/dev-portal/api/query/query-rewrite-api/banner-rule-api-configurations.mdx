---
title: "Banner Rule API Configurations"
...
The banner rule can add a banner URL to the response before returning it to the client.
...
<tr>
  <td><strong>banner_url</strong><br/><strong>Required</strong></td>
  <td>
