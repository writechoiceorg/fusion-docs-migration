...
Index profiles let your applications [send documents for indexing to a consistent endpoint](/how-to/865/import-data-with-the-rest-api) (the index profile endpoint) and change the underlying index pipeline as needed.
...
* [Index Profiles API](/fusion/5.9/znnx16/index-profiles-api) (`/index-profiles`)
