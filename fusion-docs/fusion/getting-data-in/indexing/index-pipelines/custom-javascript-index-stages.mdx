  ...
  <tbody>
    <tr>
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>
              <a
                href="/fusion-pipeline-javadocs/5.9/com/lucidworks/apollo/common/pipeline/PipelineDocument.html"
                target="_blank"
                rel="noopener"
              >
                PipelineDocument
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>The contents of each document submitted to the pipeline.</p>
          </div>
        </div>
      </td>
    </tr>
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>
              <a
                href="/fusion-pipeline-javadocs/5.9/com/lucidworks/apollo/pipeline/Context.html"
                target="_blank"
                rel="noopener"
              >
                Context
        ...
        <div class="content">
          ...
          <div class="exampleblock">
            <div class="content">
              ...
              <div class="ulist">
                <ul>
                  <li><p>Pass data from one stage to another</p></li>
                  <li><p>Store data that needs to be passed from one custom stage to a later custom stage</p></li>
                </ul>
              </div>
              <div class="paragraph">
              ...
              <div class="ulist">
                <ul>
                  <li><p>If the previous stage changes the data</p></li>
                  <li><p>Based on the configuration of each stage</p></li>
                </ul>
              </div>
              <Note>
    ...
    <tr>
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>
              <a
                href="/fusion-pipeline-javadocs/5.9/com/lucidworks/apollo/component/BufferingSolrServer.html"
                target="_blank"
                rel="noopener"
              >
                BufferingSolrServer
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>
              The Solr server instance that manages the pipeline’s default Fusion collection. All indexing and query requests are done by calls to methods on this object.
              See
              <a href="https://lucene.apache.org/solr/5_2_1/solr-solrj/org/apache/solr/client/solrj/SolrClient.html" target="_blank" rel="noopener">
                solrClient
              </a>
              for details.
            </p>
    ...
    <tr>
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>
              <a
                href="/fusion-pipeline-javadocs/5.9/com/lucidworks/cloud/api/solr/SolrClusterComponent.html"
                target="_blank"
                rel="noopener"
              >
      ...
      <td class="tableblock halign-left valign-top">
        <div class="content">
          <div class="paragraph">
            <p>
              The SolrCluster server used for lookups by collection name which returns a Solr server instance for that collection.
              For example:<br />
