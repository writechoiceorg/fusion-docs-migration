...
You configure a Grok parsing stage to use predefined [Grok patterns](/fusion/5.9/379/grok-patterns) (about 300 patterns are available) and/or Grok pattern definitions that you write yourself.
