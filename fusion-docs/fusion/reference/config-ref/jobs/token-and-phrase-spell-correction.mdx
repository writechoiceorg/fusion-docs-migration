---
title: "Token and Phrase Spell Correction Job"
permalink: "566"
---
...
You can review, edit, deploy, or delete output from this job using the [Query Rewriting UI](/fusion/5.9/489/query-rewriting#ui).
...
This job’s output, and output from the [Phrase Extraction job](/fusion/5.9/568/phrase-extraction-jobs), can be used as input for the [Synonym Detection job](/fusion/5.9/8803/synonym-detection-jobs).
