---
title: "Items-for-User Recommendations Configuration (ALS)"
permalink: "538"
---
...
* `outputItemSimCollection`/**Item-to-item Similarity Collection**
  ...
  `COLLECTION_NAME_items_for_item_recommendations` collection.
  `COLLECTION_NAME_items_for_user_recommendations` collection.
...
<Frame>![Default items-for-user recommendations pipeline](/assets/images/5.6/recommendations-item-user-pipeline-56.png)</Frame>

You can tune the [Recommend Items for User](/fusion/5.9/529/recommend-items-for-user-stage) query stage as needed to refine the output.