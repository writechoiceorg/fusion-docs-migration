---
title: "Build Training Data Jobs"
permalink: "10912"
---

Use this job to build training data for query classification by joining signals data with catalog data.

The output of this job can be used as input for the [Classification job](/fusion/5.9/8808/classification-jobs), which analyzes how documents are categorized and generates a model. That model can then be used to predict categories of new documents when they are indexed.
...
For detailed configuration steps, see [Classify New Queries](/how-to/8871/automatically-classify-new-queries). That process lets you predict the categories that are most likely to be returned successfully in a query.
