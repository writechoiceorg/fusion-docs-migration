...
For more information about available datasources and key features of the Parallel Bulk Loader, see [Parallel Bulk Loader concepts](/fusion/5.9/452/parallel-bulk-loader-pbl).
