...
*For detailed configuration instructions and examples, see [Classify New Documents at Index Time](/how-to/8872/automatically-classify-new-documents-at-index-time) or [Classify New Queries](/how-to/8871/automatically-classify-new-queries).*
...
Once you have run the job, you can specify the model name in the [Machine Learning Index Stage](/fusion/5.9/222/machine-learning-index-stage).
