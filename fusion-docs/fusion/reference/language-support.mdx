...
* **Backtranslation task.** Part of the [Data Augmentation Job](/fusion/5.9/11256/data-augmentation). Translates the input data into one or more intermediate languages before translating it back to the source language.
* **Synonym Substitution task.** Part of the [Data Augmentation Job](/fusion/5.9/11256/data-augmentation). Takes in the input text and substitutes some words with synonyms derived from the included wordner/ppdb dictionaries or user-supplied dictionaries.
* **Keystroke Misspelling task.** Part of the [Data Augmentation Job](/fusion/5.9/11256/data-augmentation). Simulates typos one might make based on the layout of the keyboard.
* **Split Word task.** Part of the [Data Augmentation Job](/fusion/5.9/11256/data-augmentation). Randomly splits words by introducing a space “ “ at some random point in the word.
